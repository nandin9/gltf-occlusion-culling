...
//		LoadedVertices.push_back(v);
		...
		// 改改改： 读取curline，获取到顶点v的索引/vt的索引/vn的索引 
		// 索引保存到 LoadedIndices 和 Indices（主要是这里）
...
//			// svert[0][1][2]是 索引（v/vt/vn的下标） ！
//			algorithm::split(sface[i], svert, "/");
			// Indices.push_back(svert[0]);
//			LoadedIndices.push_back(std::stoi(svert[0])-1);
//			Indices.push_back(std::stoi(svert[0])-1);
//		}
